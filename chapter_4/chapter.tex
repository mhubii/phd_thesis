...
\paragraph{Disclaimer} This \chapref{chap:camera_motion_prediction} is an \textit{in extenso} reproduction of \cite{huber2023deep}. Only \secref{c4:sec:introduction} was adapted to highlight additional context within the scope of this thesis.
