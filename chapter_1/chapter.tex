...
Finally, an overview of the experimental setups, including data collection and utilized hardware, is provided in \secref{c1:sec:experimental_setup}. The 

\figref{c1:fig:in_vivo_setup}

and \figref{c1:fig:calibrations}.
