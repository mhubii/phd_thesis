...
\paragraph{Disclaimer} This \chapref{chap:registration} is an \textit{in extenso} reproduction of TODO: submitted to??. Only \secref{c2:sec:introduction} was adapted to highlight additional context within the scope of this thesis.
