...
\paragraph{Disclaimer} This \chapref{chap:robotic_endoscope} is an \textit{in extenso} reproduction of \cite{huber2021homographybased}. Only \secref{c2:sec:introduction} was adapted to highlight additional context within the scope of this thesis.
