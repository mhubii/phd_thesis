\chapter[LBR-Stack]{LBR-Stack: ROS 2 and Python Integration of KUKA \acrshort{fri} for Med and
IIWA Robots}
\label{app:lbr_stack}
\minitoc
...
At the \texttt{\acrshort{lbr}-Stack}'s core are two packages:
...
\hline
Framework                                                                      & IIWA      & Med       & \acrshort{ros}       & \acrshort{ros} 2     & Hard Real-time & \acrshort{fri}       & pyFRI     & Position Control & Impedance Control & Cartesian Impedance Control & Hardware Interface \\ \hline
