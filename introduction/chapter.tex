...
\paragraph{Relation to Camera Frame Velocity} Given a projective homography $\mathbf{G}$ in image space, a camera body frame velocity that seeks to minimize 



\cite{benhimane2006homography} 
