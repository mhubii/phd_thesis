...
\end{figure}
, multiple trocars are inserted through small incisions in the abdominal wall, refer \figref{in:fig:cholecystectomy_incisions}. Trocars serve as entry points for the laparoscope and tools.
...
\cite{ALES5766} incisions, trocars, workflow
...
\multicolumn{1}{l|}{Monolithic} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}$\bullet$ da Vinci\textsuperscript{\textregistered} (Intuitive)\\ $\bullet$ avatera\textsuperscript{\textregistered} (avateramedical)\\ $\bullet$ Maestro\textsuperscript{\textregistered} (Moon Surgical)\end{tabular}} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}$\bullet$ hinotori\textsuperscript{\texttrademark} (Medicaroid)\\ $\,$\\ $\,$\end{tabular}}                                                                                                                                                            \\ \cline{2-3} 
