...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{introduction/fig/24_01_26_room_setup.pdf}
        \caption{Also refer to. Image recreated from \cite{sages2010room}.}
        \label{in:fig:room_setup}
    \end{subfigure}
    \begin{subfigure}[b]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{introduction/fig/24_01_26_cholecystectomy_incisions.pdf}
        \caption{Several incisions are made for the trocars T1-T4. A laparoscope is inserted through T1 to grant an adequate view of the surgical scene. A grasper is inserted through T2 and used by the assistant to elevate the gallbladder. Trocars T3 and T4 are used by the surgeon to perform the cholecystectomy. Image with courtesy of \cite{ALES5766} and modified to include port descriptions.}
        \label{in:fig:cholecystectomy_incisions}
    \end{subfigure}
    \caption{Surgical setup (a) and trocar incisions (b) for a cholecystectomy.}
    \label{in:fig:cholecystectomy}
\end{figure}
...
During a cholecystectomy, trocars are inserted through small incisions in the abdominal wall, similar to \figref{in:fig:laparoscopy}. Trocars serve as entry points for the laparoscope and tools.
