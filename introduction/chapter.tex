...
\begin{table}[]
\centering
\caption{Some commercial systems}
\begin{tabular}{lll}
                                       & Mechanical RCM                                                                                                                                                                                                                                                                                                             & Programmable RCM                                                                                                                                                                                                                                                                                                         \\ \cline{2-3} 
\multicolumn{1}{l|}{Monolythic} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}$\bullet$ da Vinci\textsuperscript{\textregistered} (Intuitive)\\ $\bullet$ avatera\textsuperscript{\textregistered} (avateramedical)\\ $\bullet$ Maestro\textsuperscript{\textregistered} (Moon Surgical)\end{tabular}} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}$\bullet$ hinotori\textsuperscript{\texttrademark} (Medicaroid)\\ $\,$\\ $\,$\end{tabular}}                                                                                                                                                            \\ \cline{2-3} 
\multicolumn{1}{l|}{Modular}    & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}$\bullet$ Hugo\textsuperscript{\texttrademark} (Medtronic)\\ $\bullet$ SSi Mantra\textsuperscript{\texttrademark} (SS Innovations)\\ $\,$\end{tabular}}                                                                                  & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}$\bullet$ Versius\textsuperscript{\textregistered} (CMR)\\ $\bullet$ Dexter\textsuperscript{\textregistered} (Distalmotion)\\ $\bullet$ Senhance\textsuperscript{\texttrademark} (Asensus Surgical)\end{tabular}} \\ \cline{2-3} 
\end{tabular}
\end{table}
...
\begin{figure}
    ...
    %     \caption{Maestro (outdated pictures): TODO add note following guidelines \href{https://www.moonsurgical.com/copie-de-spontaneous-application}{link}}
    % \end{subfigure}
    % \begin{subfigure}[b]{0.49\textwidth}
    %     \centering
    %     % \includegraphics[width=\textwidth]{}
    %     \caption{Dexter (to be approved, consisting of endoscope holder and patient cart)}
    % \end{subfigure}
...
\section{Towards the Operating Theater}
