...
\begin{figure}
    ...
    \label{in:fig:com}
\end{figure}
Rule-based approaches are well established for laparoscopic camera motion automation. Due to the availability of kinematic data, and the immediate applicability to the system, refer \figref{in:fig:com}, a lot of the rule-based approaches focus heavily on fully robotic systems, and use the da Vinci\textsuperscript{\textregistered} robot, as will be shown in the following paragraphs. While, as already explained in \secref{in:sec:enhancing_current_systems} - Automation, Robot-free surgeries - purely robotic surgeries pose a special case, and this thesis aims to find automation methodologies in the broader sense with transferability from MIS to RMIS, 

% \secref{in:sec:enhancing_current_systems} - Automation, System Considerations.

\paragraph{Visual Servo with mechanical RCM}
...
\paragraph{Visual Servo with programmable RCM}
...
\subsubsection{The Tool Following Assumption}
