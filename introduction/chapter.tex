...
\minitoc
% \section{Targeted Surgical Procedures}
% \subsection{Spine Surgery})
\section{Laparoscopy}
Endoscopy refers to the observation of internal parts by means of an endoscope \cite{oedendoscopy}. The word endoscopy derives from the Greek by combining the prefix "endo" meaning "within" and the verb "skopein", "to view or observe" \cite{majumdar1993short}. Laparoscopy is an endoscopic procedure inside the abdominal (belly) or pelvic (hip) cavity through small incisions for diagnostic or interventional purposes, see \figref{in:fig:laparoscopy}.
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{introduction/img/laparoscopy.png}
...
\end{figure}
In this minimally invasive surgery (MIS), the laparoscope, as well as tools, are inserted through small incisions in the abdominal wall. 
% name some types of laparoscopic surgeries -> cholest. setup, explain MIS, show the setup roughly

Compared to open surgery, laparoscopy leads to significantly faster interventions ($57.19\pm10.13\,\text{min}$ vs. $85.10\pm15.18\,\text{min}$), less bleeding complications ($2\%$ vs $7\%$ of interventions), shorter hospital stays ($2.1\pm1.1\,\text{days}$ vs $4.4\pm2.1\,\text{days}$), less infections, and less post-operative pain \cite{shi2023laparoscopic}. These eminent advantages of laparoscopic over open surgeries have long led to their adoption since the introduction in the early 1980s. This trend continues in the foreseeable future and even increases as the majority of surgical residents is nowadays trained on the minimally invasive variant, see \figref{in:fig:rise_of_laparoscopy}.

\begin{figure}
    \centering
    \begin{subfigure}[b]{0.9\textwidth}
        \centering
        \includegraphics[width=\textwidth]{introduction/img/rise_of_laparoscopic_procedures.jpg}
        \caption{Fraction of several surgical procedures performed through laparoscopy vs. open approach.}
    \end{subfigure}
    \begin{subfigure}[b]{0.9\textwidth}
        \centering
        \includegraphics[width=\textwidth]{introduction/img/rise_of_apendectomy.jpg}
        \caption{Fraction of laparoscopic appendectomy vs. open approach and vice-versa.}
    \end{subfigure}
    \caption{Relative increase in laparoscopic procedures over open approaches for surgical residents in the United States over a 16 year period from 2003 to 2018. Figures and data taken from \cite{john2020rise}. Analyzed were cholecystectomy, appendectomy, inguinal hernia repair, colectomy, gastrectomy, and Nissen fundoplication.}
    \label{in:fig:rise_of_laparoscopy}
\end{figure}

% In parts of this work

\section{Robot Assisted Laparoscopy}
\subsection{Robotic Surgery Platforms}
\section{Methodologies for Robotic Automation applicable to...}
\subsection{Rule-based Approaches}
\subsection{Imitation Learning}
\subsection{Reinforcement Learning}
\section{Proposed Camera Motion Automation}
