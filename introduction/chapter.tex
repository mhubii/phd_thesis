...
Others~\cite{lecun2022path} have argued that machines will need to interact with the real world in order to become truly intelligent and, arguably, \acrshort{rmis} has grown to be the most advanced \acrfull{rmis} domain with thousands of deployed robots.
\begin{figure}[tbh]
    \centering
